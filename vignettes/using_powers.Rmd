...
Want squares, cubes, or reciprocals? Easy. You can also do a boxcox transform now!
...
It even comes with the ability to display its output in plot form! I now added the ability to plot with boxcox now.

```{r}
reciprocal(1:10, plot_it = TRUE)
boxcox(1:10, 2, plot_it = TRUE)
```
